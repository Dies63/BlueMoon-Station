...
/datum/interaction/lewd/massage_nuts/display_interaction(mob/living/user, mob/living/partner, is_hidden)
	...
	if(user.is_fucking(partner, NUTS_MASSAGE))
		message = pick(list(
			"продолжает нежно массировать семенники <b>[partner]</b>, чувствуя, как они напрягаются в [partner.ru_ego()] руке.",
			"усиливает давление на яйца <b>[partner]</b>, заставляя [partner.ru_ego()] дышать чаще.",
			"медленно перекатывает семенники <b>[partner]</b> в [partner.ru_ego()] ладони, наслаждаясь их тяжестью.",
